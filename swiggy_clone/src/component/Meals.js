...
import { checkAvailability, findQuantity, removeMenu } from "../utils/cardsData";
...
const Meals = (curMenu) => {
    ...
    const restroDataList = useContext(RestaurantDetailsContext);
...
//Cart operations
    ...
    const handleAdd = (meal) => {
        const check = checkAvailability(resId, meal, cartItems, dispatch, restroDataList);
        if(check){
